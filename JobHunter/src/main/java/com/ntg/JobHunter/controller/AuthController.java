...
import com.ntg.JobHunter.domain.res.LoginResponse;
import com.ntg.JobHunter.domain.User;
import com.ntg.JobHunter.domain.dto.LoginDTO;
import com.ntg.JobHunter.service.SecurityService;
import com.ntg.JobHunter.service.UserService;
import com.ntg.JobHunter.utils.annotation.ApiMessage;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse.UserGetAccount> getAccount(){
        ...
        LoginResponse.UserLogin userLogin = new LoginResponse.UserLogin();
        LoginResponse.UserGetAccount userGetAccout = new LoginResponse.UserGetAccount();
        if(currentUserDB != null){
